...
.controller('AppCtrl', function ($scope, $ionicModal, $timeout, $localStorage) {
    ...
    $scope.doReserve = function () {
        ...
        // Remove this and replace with your reservation code
        // if using a server system
        $timeout(function () {
            $scope.closeReserve();
        }, 1000);
    };
...
.controller('MenuController', ['$scope', 'favoriteFactory', 'dishes', 'baseURL', '$ionicListDelegate', function ($scope, favoriteFactory, dishes, baseURL, $ionicListDelegate) {
